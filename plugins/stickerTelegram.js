...
let handler = async (m, { conn, args, usedPrefix, command }) => {
    if (!args[0]) throw `*Este comando para recuperar pegatinas de Telegram*\n\nejemplo:\n${usedPrefix + command} https://t.me/addstickers/menggokil`
    if (!args[0].match(/(https:\/\/t.me\/addstickers\/)/gi)) throw `*¡Link incorrecto! Este comando para recuperar pegatinas de Telegram*\n\nejemplo:\n${usedPrefix + command} https://t.me/addstickers/menggokil`
